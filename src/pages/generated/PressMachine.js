                ...
                <div className="container">
                    <div className="premium-split">
                        ...
                        <div className="premium-split-content premium-animate slide-up" style={{ transitionDelay: '0.2s' }}>
                            ...
                            <p>We deploy industrial-grade Press Machine Automation frameworks designed to bring cloud-level intelligence directly to your factory floor. Every integration ensures modularity, maximum uptime, and robust protocol security conforming to global manufacturing requirements.</p>
            ...
            <section className="premium-section-padding premium-bg-white">
                <div className="container">
                    <div className="premium-header premium-animate slide-up">
                        ...
                        <p>How Press Machine Automation continuously drives enterprise value.</p>
                    </div>
